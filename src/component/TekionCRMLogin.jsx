...
export default function TekionCRMLogin({ onLogin }) {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const submitData = { ...formData, userType, isSignup };
    if (userType === 'salesperson' && isSignup) {
      submitData.expertise = selectedExpertise;
    }
    console.log('Form submitted:', submitData);
    if(onLogin) onLogin(userType, submitData);
  };
